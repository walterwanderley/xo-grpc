...
const (
	EmployeeService_Delete_FullMethodName               = "/employee.v1.EmployeeService/Delete"
	EmployeeService_EmployeeByEmployeeID_FullMethodName = "/employee.v1.EmployeeService/EmployeeByEmployeeID"
	EmployeeService_Insert_FullMethodName               = "/employee.v1.EmployeeService/Insert"
	EmployeeService_Update_FullMethodName               = "/employee.v1.EmployeeService/Update"
	EmployeeService_Upsert_FullMethodName               = "/employee.v1.EmployeeService/Upsert"
)
...
func (c *employeeServiceClient) EmployeeByEmployeeID(ctx context.Context, in *EmployeeByEmployeeIDRequest, opts ...grpc.CallOption) (*v1.Employee, error) {
	out := new(v1.Employee)
	err := c.cc.Invoke(ctx, EmployeeService_EmployeeByEmployeeID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *employeeServiceClient) Insert(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, EmployeeService_Insert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *employeeServiceClient) Upsert(ctx context.Context, in *UpsertRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, EmployeeService_Upsert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EmployeeService_EmployeeByEmployeeID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmployeeService_EmployeeByEmployeeID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmployeeService_Insert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmployeeService_Insert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmployeeService_Upsert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmployeeService_Upsert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
