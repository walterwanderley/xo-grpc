...
type EmployeeTerritoryServiceClient interface {
	...
	EmployeeTerritoryByEmployeeIDTerritoryID(ctx context.Context, in *EmployeeTerritoryByEmployeeIDTerritoryIDRequest, opts ...grpc.CallOption) (*v1.EmployeeTerritory, error)
	Insert(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Territory(ctx context.Context, in *TerritoryRequest, opts ...grpc.CallOption) (*v1.Territory, error)
}
...
func (c *employeeTerritoryServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/employee_territory.v1.EmployeeTerritoryService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *employeeTerritoryServiceClient) Employee(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*v1.Employee, error) {
	out := new(v1.Employee)
	err := c.cc.Invoke(ctx, "/employee_territory.v1.EmployeeTerritoryService/Employee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *employeeTerritoryServiceClient) EmployeeTerritoryByEmployeeIDTerritoryID(ctx context.Context, in *EmployeeTerritoryByEmployeeIDTerritoryIDRequest, opts ...grpc.CallOption) (*v1.EmployeeTerritory, error) {
	out := new(v1.EmployeeTerritory)
	err := c.cc.Invoke(ctx, "/employee_territory.v1.EmployeeTerritoryService/EmployeeTerritoryByEmployeeIDTerritoryID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *employeeTerritoryServiceClient) Insert(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/employee_territory.v1.EmployeeTerritoryService/Insert", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *employeeTerritoryServiceClient) Territory(ctx context.Context, in *TerritoryRequest, opts ...grpc.CallOption) (*v1.Territory, error) {
	out := new(v1.Territory)
	err := c.cc.Invoke(ctx, "/employee_territory.v1.EmployeeTerritoryService/Territory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmployeeTerritoryServiceServer interface {
	...
	EmployeeTerritoryByEmployeeIDTerritoryID(context.Context, *EmployeeTerritoryByEmployeeIDTerritoryIDRequest) (*v1.EmployeeTerritory, error)
	Insert(context.Context, *InsertRequest) (*emptypb.Empty, error)
	Territory(context.Context, *TerritoryRequest) (*v1.Territory, error)
...
func (UnimplementedEmployeeTerritoryServiceServer) Employee(context.Context, *EmployeeRequest) (*v1.Employee, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Employee not implemented")
}
func (UnimplementedEmployeeTerritoryServiceServer) EmployeeTerritoryByEmployeeIDTerritoryID(context.Context, *EmployeeTerritoryByEmployeeIDTerritoryIDRequest) (*v1.EmployeeTerritory, error) {
...
func (UnimplementedEmployeeTerritoryServiceServer) Territory(context.Context, *TerritoryRequest) (*v1.Territory, error) {
...
func _EmployeeTerritoryService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/employee_territory.v1.EmployeeTerritoryService/Delete",
	}
...
func _EmployeeTerritoryService_Employee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/employee_territory.v1.EmployeeTerritoryService/Employee",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmployeeTerritoryService_EmployeeTerritoryByEmployeeIDTerritoryID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/employee_territory.v1.EmployeeTerritoryService/EmployeeTerritoryByEmployeeIDTerritoryID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmployeeTerritoryService_Insert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/employee_territory.v1.EmployeeTerritoryService/Insert",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmployeeTerritoryService_Territory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/employee_territory.v1.EmployeeTerritoryService/Territory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var EmployeeTerritoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "employee_territory.v1.EmployeeTerritoryService",
	...
	Metadata: "employee_territory/v1/employee_territory.proto",
}
